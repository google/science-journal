...
public class MkrSciBleSensorAppearance extends BuiltInSensorAppearance {
    ...
    private MkrSciBleSensorAppearance(String sensorId,
                                      String handlerId,
                                      int nameStringId,
                                      int drawableId,
                                      int unitsStringId,
        ...
        super(nameStringId, drawableId, unitsStringId, shortDescriptionId, firstParagraphStringId,
                ...
                pointsAfterDecimalInNumberFormat, builtInSensorId);
        mSensorId = sensorId;
    ...
    public GoosciIcon.IconPath getSmallIconPath() {
        ...
        path.type = GoosciIcon.IconPath.MKRSCI_ANDROID_BLE;
        path.pathString = mSensorId + ":" + Strings.nullToEmpty(mHandlerId);
        return path;
    }
