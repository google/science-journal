...
import com.google.android.apps.forscience.whistlepunk.devicemanager.MkrSciBleDiscoverer;
...
@Module
public class MkrSciBleDiscovererModule {
    @Provides
    @IntoMap
    @StringKey(MkrSciBleDeviceSpec.TYPE)
    public SensorDiscoverer providesNativeDiscoverer(Context context) {
        return new MkrSciBleDiscoverer(context);
    }
}
