...
public class NativeBleDiscoverer implements SensorDiscoverer {
    ...
    public boolean startScanning(final ScanListener listener, FailureListener onScanError) {
        ...
        listener.onServiceFound(new DiscoveredService() {
            ...
            public String getName() {
                return mContext.getString(R.string.arduino_boards);
            }
    ...
    private void onMkrSciDeviceRecordFound(DeviceDiscoverer.DeviceRecord record,
                                           ScanListener scanListener) {
        WhistlepunkBleDevice device = record.device;
        ...
        addMkrSciSensor(scanListener, address, SENSOR_INPUT_1, mContext.getString(R.string.input_1));
        addMkrSciSensor(scanListener, address, SENSOR_INPUT_2, mContext.getString(R.string.input_2));
        addMkrSciSensor(scanListener, address, SENSOR_INPUT_3, mContext.getString(R.string.input_3));
        addMkrSciSensor(scanListener, address, SENSOR_VOLTAGE, mContext.getString(R.string.voltage));
        addMkrSciSensor(scanListener, address, SENSOR_CURRENT, mContext.getString(R.string.current));
        addMkrSciSensor(scanListener, address, SENSOR_RESISTANCE, mContext.getString(R.string.resistance));
        addMkrSciSensor(scanListener, address, SENSOR_ACCELEROMETER_X, mContext.getString(R.string.acc_x));
        addMkrSciSensor(scanListener, address, SENSOR_ACCELEROMETER_Y, mContext.getString(R.string.acc_y));
        addMkrSciSensor(scanListener, address, SENSOR_ACCELEROMETER_Z, mContext.getString(R.string.acc_z));
        addMkrSciSensor(scanListener, address, SENSOR_LINEAR_ACCELEROMETER, mContext.getString(R.string.linear_accelerometer));
        addMkrSciSensor(scanListener, address, SENSOR_GYROSCOPE_X, mContext.getString(R.string.gyr_x));
        addMkrSciSensor(scanListener, address, SENSOR_GYROSCOPE_Y, mContext.getString(R.string.gyr_y));
        addMkrSciSensor(scanListener, address, SENSOR_GYROSCOPE_Z, mContext.getString(R.string.gyr_z));
        addMkrSciSensor(scanListener, address, SENSOR_MAGNETOMETER, mContext.getString(R.string.magnetic_field_strength));
    }

    private void addMkrSciSensor(ScanListener scanListener, String address, String sensor, String name) {
