...
import com.google.android.apps.forscience.whistlepunk.modules.MkrSciBleDiscovererModule;
...
@Component(modules = {FeatureDiscoveryModule.class, FeedbackModule.class, UsageTrackerModule.class,
        NativeBleDiscovererModule.class, MkrSciBleDiscovererModule.class, InputDeviceModule.class,
